...
\item {\bf Declaration of LLM usage}
    ...
    \item[] Answer: \answerNA{}
    \item[] Justification: LLMs are not used as a core component of PRISM's methodology, training, or evaluation. LLM tools were used only for writing assistance and do not affect scientific content.
